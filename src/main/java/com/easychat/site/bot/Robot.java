...
public  class Robot {
	...
	static{
        REST_PROTOCOL = resourceBundle.getString("bot.rest.protocol");
        REST_HOST = resourceBundle.getString("bot.rest.host");
        REST_PORT = Integer.valueOf(resourceBundle.getString("bot.rest.port"));
        REST_URL = resourceBundle.getString("bot.rest.url");
